...
- [ ] 2.1 Build the loan card component matching Figma (`37:160`) — status, balance, payment, progress bar, next payment date
- [ ] 2.2 Build the list screen with empty state
- [ ] 2.3 Wire list data fetching via TanStack Query

## 3. Manual application

- [ ] 3.1 Build the "solicitar préstamo" entry affordance on the list screen
- [ ] 3.2 Build the application form (amount, term, purpose)
- [ ] 3.3 Wire submission and result state (approved/pending/rejected/needs more info)
...
- [ ] 5.2 Screenshot comparison against Figma node `37:160`
